...
export default function CarpetView({
  ...
  const updateSizeFromSlider = (clientY: number) => {
    const track = sizeSliderTrackRef.current;
    if (!track) return;
    const rect = track.getBoundingClientRect();
    // Past = 0 (kichik), yuqori = 100 (katta)
    ...
    >
      <div className="max-w-4xl w-full mx-auto h-900px]">
        ...
        {!roomImage ? (
          ...
          <div>
            <div className="bg-gray-800 rounded-lg overflow-hidden mb-6 relative select-none">
              <img
                src={roomImage}
                alt="Your room"
              ...
              {/* Volume-style vertical slider: yuqoriga = katta, pastga = kichik */}
              <div
              ...
              >
                <div
                  ...
                  style={{
                    top: `${
                      100 - Math.max(0, Math.min(100, sizeScalePercent))
                    }%`,
                  }}
              ...
              >
                <div className="relative w-full h-full">
                  ...
                  <div
                    className="absolute -top-12 right-10 w-10 h-10 bg-green-500 rounded-full cursor-grab hover:bg-green-600 flex items-center justify-center text-white shadow-xl transition-all hover:scale-110 pointer-events-auto"
